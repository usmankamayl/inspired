  ...
  return (
    <div className={s.top}>
      <Container className={s.topContainer}>
        <a href="tel:89304902620" className={classNames(s.topLink, s.topPhone)}>8 930 490 26 20</a>
            ...
            <li>
              <button className={s.topLink}>
                <svg width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none"
                  ...
                  <path d="M16.4431 16.4438L20.9994 21.0002" strokeWidth="2" strokeLinecap="round"
